...
class DivulgacaoAgendAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','rede_social', 'tipo_post', 'data_criacao', 'legenda','hora', 'ultima_publicacao')
    
    # Filtros na lateral direita
    list_filter = ('id','rede_social', 'tipo_post', 'data_criacao', 'legenda','ultima_publicacao')
